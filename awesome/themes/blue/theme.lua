...
theme.wallpaper = theme.path .. "/wallpaper/custom.jpg" -- wallpaper file

-- Fonts
------------------------------------------------------------
theme.fonts = {
	main     = "Hack 11",      -- main font
	menu     = "Hack 11",      -- main menu font
	tooltip  = "Hack 10",      -- tooltip font
	notify   = "Play bold 14",   -- redflat notify popup font
	clock    = "Hack bold 11",   -- textclock widget font
	qlaunch  = "Play bold 14",   -- quick launch key label font
	keychain = "Play bold 16",   -- key sequence tip font
	title    = "Hack bold 12", -- widget titles font
	titlebar = "Hack bold 12", -- client titlebar font
	hotkeys  = {
		main  = "Hack 14",             -- hotkeys helper main font
		key   = "Hack bold 14", -- hotkeys helper key font (use monospace for align)
		title = "Hack bold 16",        -- hotkeys helper group title font
	},
	player   = {
...
theme.desktop.grid = {
	width  = { 520, 520, 520 },
	height = { 70, 160, 160, 160, 18, 18, 70 },
	edge   = { width = { 40, 40 }, height = { 20, 20 } }
}
...
theme.float.apprunner = {
	itemnum       = 3,
	geometry      = { width = 620, height = 240 },
	border_margin = { 8, 8, 8, 8 },
	icon_margin   = { 8, 16, 0, 0 },
	title_height  = 48,
	prompt_height = 36,
	title_icon    = theme.path .. "/widget/search.svg",
	keytip        = { geometry = { width = 400, height = 130 } },
	border_width  = 0,
